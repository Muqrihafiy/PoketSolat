...
import '../models/modelbacaan.dart';

class BacaanSolat extends StatefulWidget {
  const BacaanSolat({Key? key}) : super(key: key);

  @override
  _BacaanSolatState createState() => _BacaanSolatState();
}

class _BacaanSolatState extends State<BacaanSolat> {
  Future<List<ModelBacaan>> ReadJsonData() async {
    final jsondata =
    await rootBundle.rootBundle.loadString('android/assets/datasurah/bacaansolat.json');
