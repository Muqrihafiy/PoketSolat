...
import 'Components/QuestionModel2.dart';
import 'score_screen2.dart';
...
class Question2Controller extends GetxController
  ...
  List<Question2> _questions = sample_data
      .map(
        (question) => Question2(
        id: question['id'],
  ...
  void nextQuestion() {
    if (_questionNumber.value != _questions.length) {
      ...
      Get.off(() =>ScoreScreen2(correctNum: _numOfCorrectAns)); // GetMaterialApp()
